...
const fetchAllChildThreads = async (
  ...
  for (const childThread of childThreads) {
    const descendants =
      await fetchAllChildThreads(childThread._id);
    descendantThreads.push(
      childThread,
      ...descendants
    );
  }
...
export const deleteThread = async (
  ...
  try {
    ...
    const mainThread = await Thread.findById(
      id
        ...
        populate: [
          ...
          },
          {
            ...
            populate: {
              ...
              model: User,
              select:
                "_id id name parentId image", // Select only _id and username fields of the author
            },
          },
        ],
      })
