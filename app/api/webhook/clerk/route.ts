...
export const POST = async (request: Request) => {
  ...
  const heads = {
    ...
    "svix-timestamp": header.get(
      "svix-timestamp"
    ),
    "svix-signature": header.get(
      "svix-signature"
    ),
  };
  ...
  if (
    ...
    try {
      ...
      await removeUserFromCommunity(
        // @ts-ignore
        public_user_data.user_id, // @ts-ignore
        organization.id
      );
